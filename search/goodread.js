...
module.exports.meta = {
    category: "Search & Islami",
    tag: "SRCH",
    endpoints: [
        {
            method: "GET",
            path: "/caribuku",
            desc: "Cari informasi buku dari GoodReads",
            tryUrl: "/caribuku?search=nabawiyah",
            params: [{ name: "search", required: true, desc: "Judul atau nama buku" }]
        }
    ]
};
